...
class BindingTests(SimpleTestCase):
    ...
    def setUp(self):
        ...
        self.bindings = PLUGIN.bind(self.state, {"character_occupancy": self.occupancy})
    ...
    def test_the_plugin_declares_its_own_state_slot(self):
        """The slot `current_location_now`'s own state, and every other
        binding here, is actually stored under."""
